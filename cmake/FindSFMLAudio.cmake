...
#  SFMLAudio_FOUND - system has sfml audio
#  SFMLAudio_INCLUDE_DIRS - the sfml audio include directory
#  SFMLAudio_LIBRARIES - Link these to use SFML
#
# Author: Frédéric Sanchez <frederic.sanchez@epitech.eu> (06/2020)
#
...
IF (NOT SFMLAudio_INCLUDE_DIRS OR NOT SFMLAudio_LIBRARIES)
  FIND_PATH(SFMLAudio_INCLUDE_DIRS
    ...
    PATHS
      ...
      ${SFMLAudio_DIR}/             # SFML root directory (if provided)
  )
...
IF (SFMLAudio_FIND_REQUIRED AND NOT SFMLAudio_FOUND)
  MESSAGE(FATAL_ERROR
    ...
    "      Linux: Install SMFL using your package manager ($> sudo dnf install sfml-devel).\n"
  )
